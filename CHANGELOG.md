...
- **Dark themes now print with dark headings and links**: with Dracula, GitHub Dark Dimmed, Obsidiminutive, or a theme of your own that sets `--mdm-color-scheme: dark`, headings print near-black and links dark blue on the white page. A link in a table's header row prints in the header's text colour, so it stays readable on the dark header. Default and the light themes print as before. Before, a dark theme's headings and links printed in their screen colours, too pale to read on white paper.
